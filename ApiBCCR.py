...
class BCCRTipoCambio:
    def __init__(self, correo, token):
        self.correo = correo
        self.token = token
        self.url = (
...
def usarApi():
    correo = "apicbccrprueba@gmail.com"  
    token = "NBPEINGIME"
    bccr = BCCRTipoCambio(correo, token) #Aquí se crea una instancia de la clase con el correo y token
